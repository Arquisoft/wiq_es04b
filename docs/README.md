...
If we want to deploy it to GitHub pages, so it is accessible via [https://arquisoft.github.io/wiq_es04b/](https://arquisoft.github.io/wiq_es04b/), we need to execute `npm run deploy`.
